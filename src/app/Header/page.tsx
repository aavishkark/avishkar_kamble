...
export default function Header() {
  ...
  const animationProps = useSpring({
    opacity: inView ? 1 : 0,
    transform: inView ? '' : 'translateY(-20px)',
    config: { tension: 600, friction: 20 },
  });

  return (
    <animated.header className="header" ref={ref} style={animationProps}>
      <div className="logo">
      ...
      <nav>
        <ul className="navigation">
          ...
          <li>
            <a
              href="https://drive.google.com/file/d/1vWdhyJfYFhMgeXtLY72dOiDOC7wL-ebL/view?usp=sharing"
              target="_blank"
      ...
      <a href="#contactme" className="contactme-btn">
        <div className="contactme">
          <svg className='contactme-icon' height="14" width="14" viewBox="0 0 512 512">
      ...
      <div className='mobile-view'>
        ...
        <div className={`ham-menu ${isOpen ? 'enabled' : 'disabled'}`}>
          <ul className="ham-menu-list">
            ...
            <li>
              <a
                href="https://drive.google.com/file/d/1QVhmAYFmD_hLpICW_TM_LQBQ0CF60P42/view?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
              >
                Resume
